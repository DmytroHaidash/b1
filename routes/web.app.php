...
Route::group([
    ...
    Route::get('{page}', 'PagesController@show')->name('page')
        ->where('page', '(about|contacts|expertise|terms-and-conditions)');
    Route::post('/expertise', 'PagesController@expertise')->name('expertise');
    Route::post('/contacts', 'PagesController@contacts')->name('contacts');
});